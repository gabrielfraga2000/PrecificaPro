...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121212] flex items-center justify-center p-4 font-sans">
      <main className="w-full max-w-md bg-[#353535] rounded-3xl shadow-2xl shadow-black/50 overflow-hidden border border-[#545454]">
        
        {/* Header */}
        <header className="bg-[#353535] px-6 py-6 border-b border-[#545454] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="bg-[#b2ff51]/10 p-2.5 rounded-xl text-[#b2ff51]">
              <CalculatorIcon size={24} strokeWidth={2.5} />
            </div>
            <div>
              <h1 className="text-xl font-bold text-white leading-tight">PrecificaPro</h1>
              <p className="text-xs font-medium text-gray-400">Calculadora Dinâmica</p>
            </div>
          </div>
          <button 
            onClick={handleReset}
        ...
        <div className="p-6">
          <form className="flex flex-col gap-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <div>
              ...
              />
              {hasError && (
                <div className="flex items-center gap-1 mt-2 text-red-400 text-xs font-medium animate-pulse">
                  <AlertCircle size={12} />
            ...
            <div className="flex flex-col gap-1.5">
              <label htmlFor="installments" className="text-sm font-semibold text-gray-300">
                Número de Parcelas
              </label>
              <div className="relative">
                <select
                  ...
                  className="w-full appearance-none rounded-lg border-2 border-[#545454] bg-[#262626] py-3 px-4 text-lg font-bold text-white focus:border-[#b2ff51] focus:outline-none focus:ring-1 focus:ring-[#b2ff51] transition-all cursor-pointer hover:border-gray-500"
                >
          ...
          {/* Empty State / Prompt */}
          {!result && !hasError && (
            <div className="mt-8 text-center p-6 bg-[#262626] rounded-2xl border border-[#545454] border-dashed">
